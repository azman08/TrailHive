      ...
      >
        {movies.map((movie) => {
          return (
            <SwiperSlide
              key={movie.id}
              className="relative rounded-lg overflow-hidden lg:aspect-video cursor-pointer bg-gradient-to-t from-gray-950 via-transparent"
            ...
            >
              ...
              <div className="flex flex-col justify-end h-full p-5">
                ...
                <p className="font-thin line-clamp-1 xl:line-clamp-3">
                  {movie.overview}
                </p>
              </div>
            </SwiperSlide>
