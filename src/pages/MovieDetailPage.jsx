        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
          <span className="order-2 grid items-center">
            <div className="overflow-hidden">
              <h1 className="md:text-5xl text-xl font-bold text-center lg:text-start my-5 h-max">
                {title}
              </h1>
              ...
              <span className="grid lg:max-xl:grid-cols-1 max-md:grid-cols-1 grid-cols-2 items-center justify-between">
                ...
                <span className="flex justify-between text-sm md:text-base">
                  ...
                  <p>
                    ...
                    <BsStarFill size={16} className="inline" />
                  </p>
                </span>
              </span>
              <span className={`${isHasRecommendation ? "" : "invisible"}`}>
                ...
                <Movies
                  fetchData={fetchRecommendation}
                  isHasRecommendation={isHasRecommendationHandler}
                />
              </span>
              <Link
                to="/"
                className="bg-gray-950 rounded-lg border font-medium py-1 px-3"
              >
                Back to Home
              </Link>
            </div>
